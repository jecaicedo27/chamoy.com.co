...
export function organizationJsonLd() {
  return {
    ...
    name: site.name,
    alternateName: [site.brand, "chamoy.com.co"],
    brand: { "@type": "Brand", "@id": `${site.url}/#brand`, name: site.brand },
    url: site.url,
    description: `Fabricantes de ${site.brand}: salsa y sirope de chamoy hechos en Colombia, con venta directa y envío a todo el país.`,
    logo: {
      "@type": "ImageObject",
